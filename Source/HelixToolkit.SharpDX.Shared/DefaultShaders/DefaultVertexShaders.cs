...
#endif
{
    namespace Shaders
    {
        ...
        public static class DefaultVSShaderDescriptions
        {
            ...
            #region Terrain Vertex Shader Description
            /// <summary>
            /// 
            /// </summary>
            ...
            /// 
            /// </summary>
            public static readonly ShaderDescription VSTerrainGenerateVertices = new ShaderDescription(
                nameof(VSTerrainGenerateVertices),
                ShaderStage.Vertex,
                new ShaderReflector(),
                DefaultVSShaderByteCodes.VSTerrainGenerateVertices);
            /// <summary>
            /// 
            /// </summary>
            public static readonly ShaderDescription VSTerrainGenerateIndices = new ShaderDescription(
                nameof(VSTerrainGenerateIndices),
                ShaderStage.Vertex,
                new ShaderReflector(),
