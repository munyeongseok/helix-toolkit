        ...
        private IEnumerable<TechniqueDescription> LoadTechniqueDescriptions()
        {
            ...
            var renderTerrain = new TechniqueDescription(DefaultRenderTechniqueNames.Terrain)
            {
                ...
                PassDescriptions = new[]
                {
                    ...
                    new ShaderPassDescription(ProceduralTerrainGenerationPassNames.ListVerticesToGenerate)
                    {
                        ShaderList = new[]
                        {
                            DefaultVSShaderDescriptions.VSTerrainListVerticesToGenerate,
                            DefaultGSShaderDescriptions.GSTerrainListVerticesToGenerate
                        },
                        BlendStateDescription = DefaultBlendStateDescriptions.NoBlend,
                        DepthStencilStateDescription = DefaultDepthStencilDescriptions.DSSNoDepthNoStencil,
                        Topology = PrimitiveTopology.Undefined
                    },
                    new ShaderPassDescription(ProceduralTerrainGenerationPassNames.SplatVertexIDs)
                    {
                        ShaderList = new[]
                        {
                            DefaultVSShaderDescriptions.VSTerrainSplatVertexIDs,
                            DefaultGSShaderDescriptions.GSTerrainSplatVertexIDs,
                            DefaultPSShaderDescriptions.PSTerrainSplatVertexIDs
                        },
                        BlendStateDescription = DefaultBlendStateDescriptions.NoBlend,
                        DepthStencilStateDescription = DefaultDepthStencilDescriptions.DSSNoDepthNoStencil,
                        Topology = PrimitiveTopology.Undefined
                    ...
                    new ShaderPassDescription(ProceduralTerrainGenerationPassNames.GenerateIndices)
                    {
                        ShaderList = new[]
                        {
                            DefaultVSShaderDescriptions.VSTerrainGenerateIndices,
                            DefaultGSShaderDescriptions.GSTerrainGenerateIndices
                        },
                        BlendStateDescription = DefaultBlendStateDescriptions.NoBlend,
                        DepthStencilStateDescription = DefaultDepthStencilDescriptions.DSSNoDepthNoStencil,
                        Topology = PrimitiveTopology.Undefined
                    },
                    new ShaderPassDescription(ProceduralTerrainGenerationPassNames.DrawRock)
                    {
                        ShaderList = new[]
                        {
                            DefaultVSShaderDescriptions.VSTerrainDrawRock,
                            DefaultPSShaderDescriptions.PSTerrainDrawRock
                        },
                        BlendStateDescription = DefaultBlendStateDescriptions.NoBlend,
                        DepthStencilStateDescription = DefaultDepthStencilDescriptions.DSSNoDepthNoStencil,
                        Topology = PrimitiveTopology.Undefined
